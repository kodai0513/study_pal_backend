...
const (
	// Label holds the string label denoting the trueorfalseproblem type in the database.
	Label = "true_or_false_problem"
	...
	WorkbookTable = "true_or_false_problems"
	...
	WorkbookCategoryTable = "true_or_false_problems"
...
// OrderOption defines the ordering options for the TrueOrFalseProblem queries.
