...
const (
	// Label holds the string label denoting the answertype type in the database.
	Label = "answer_type"
	...
	// Table holds the table name of the answertype in the database.
	Table = "answer_types"
	...
	ProblemsColumn = "answer_type_id"
)

// Columns holds all SQL columns for answertype fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AnswerType queries.
