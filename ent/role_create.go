...
func (rc *RoleCreate) check() error {
	...
	if len(rc.mutation.PermissionsIDs()) == 0 {
		return &ValidationError{Name: "permissions", err: errors.New(`ent: missing required edge "Role.permissions"`)}
	}
	return nil
}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.WorkbookMembersIDs(); len(nodes) > 0 {
