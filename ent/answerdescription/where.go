...
func NameEQ(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldEQ(FieldName, v))
}

// NameNEQ applies the NEQ predicate on the "name" field.
func NameNEQ(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldNEQ(FieldName, v))
}

// NameIn applies the In predicate on the "name" field.
func NameIn(vs ...string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldIn(FieldName, vs...))
}

// NameNotIn applies the NotIn predicate on the "name" field.
func NameNotIn(vs ...string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldNotIn(FieldName, vs...))
}

// NameGT applies the GT predicate on the "name" field.
func NameGT(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldGT(FieldName, v))
}

// NameGTE applies the GTE predicate on the "name" field.
func NameGTE(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldGTE(FieldName, v))
}

// NameLT applies the LT predicate on the "name" field.
func NameLT(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldLT(FieldName, v))
}

// NameLTE applies the LTE predicate on the "name" field.
func NameLTE(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldLTE(FieldName, v))
}

// NameContains applies the Contains predicate on the "name" field.
func NameContains(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldContains(FieldName, v))
}

// NameHasPrefix applies the HasPrefix predicate on the "name" field.
func NameHasPrefix(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldHasPrefix(FieldName, v))
}

// NameHasSuffix applies the HasSuffix predicate on the "name" field.
func NameHasSuffix(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldHasSuffix(FieldName, v))
}

// NameEqualFold applies the EqualFold predicate on the "name" field.
func NameEqualFold(v string) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.FieldEqualFold(FieldName, v))
}
...
func And(predicates ...predicate.AnswerDescription) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.AnswerDescription) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.AnswerDescription) predicate.AnswerDescription {
	return predicate.AnswerDescription(sql.NotPredicates(p))
}
