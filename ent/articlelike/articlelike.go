...
const (
	// Label holds the string label denoting the articlelike type in the database.
	Label = "article_like"
	...
	EdgeArticle = "article"
	// Table holds the table name of the articlelike in the database.
	Table = "article_likes"
	// ArticleTable is the table that holds the article relation/edge.
	ArticleTable = "article_likes"
...
// Columns holds all SQL columns for articlelike fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ArticleLike queries.
