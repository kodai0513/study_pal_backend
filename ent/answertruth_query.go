...
// Where adds a new predicate for the AnswerTruthQuery builder.
func (atq *AnswerTruthQuery) Where(ps ...predicate.AnswerTruth) *AnswerTruthQuery {
	atq.predicates = append(atq.predicates, ps...)
	return atq
}

// Limit the number of records to be returned by this query.
func (atq *AnswerTruthQuery) Limit(limit int) *AnswerTruthQuery {
	atq.ctx.Limit = &limit
	return atq
}

// Offset to start from.
func (atq *AnswerTruthQuery) Offset(offset int) *AnswerTruthQuery {
...
func (atq *AnswerTruthQuery) Unique(unique bool) *AnswerTruthQuery {
...
// Returns a *NotFoundError when no AnswerTruth was found.
func (atq *AnswerTruthQuery) First(ctx context.Context) (*AnswerTruth, error) {
	nodes, err := atq.Limit(1).All(setContextOp(ctx, atq.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{answertruth.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (atq *AnswerTruthQuery) FirstX(ctx context.Context) *AnswerTruth {
...
// Only returns a single AnswerTruth entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one AnswerTruth entity is found.
// Returns a *NotFoundError when no AnswerTruth entities are found.
func (atq *AnswerTruthQuery) Only(ctx context.Context) (*AnswerTruth, error) {
	...
	case 0:
		return nil, &NotFoundError{answertruth.Label}
	default:
		return nil, &NotSingularError{answertruth.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (atq *AnswerTruthQuery) OnlyX(ctx context.Context) *AnswerTruth {
...
func (atq *AnswerTruthQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{answertruth.Label}
	default:
		err = &NotSingularError{answertruth.Label}
	}
	return
}
...
// All executes the query and returns a list of AnswerTruths.
func (atq *AnswerTruthQuery) All(ctx context.Context) ([]*AnswerTruth, error) {
	ctx = setContextOp(ctx, atq.ctx, ent.OpQueryAll)
	if err := atq.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*AnswerTruth, *AnswerTruthQuery]()
	return withInterceptors[[]*AnswerTruth](ctx, atq, qr, atq.inters)
}

// AllX is like All, but panics if an error occurs.
func (atq *AnswerTruthQuery) AllX(ctx context.Context) []*AnswerTruth {
...
func (atq *AnswerTruthQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = atq.Select(answertruth.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (atq *AnswerTruthQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, atq.ctx, ent.OpQueryCount)
	if err := atq.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, atq, querierCount[*AnswerTruthQuery](), atq.inters)
}

// CountX is like Count, but panics if an error occurs.
func (atq *AnswerTruthQuery) CountX(ctx context.Context) int {
...
func (atq *AnswerTruthQuery) Exist(ctx context.Context) (bool, error) {
...
func (atq *AnswerTruthQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the AnswerTruthQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (atq *AnswerTruthQuery) Clone() *AnswerTruthQuery {
	if atq == nil {
		return nil
	}
...
func (atq *AnswerTruthQuery) GroupBy(field string, fields ...string) *AnswerTruthGroupBy {
	...
	grbuild := &AnswerTruthGroupBy{build: atq}
	grbuild.flds = &atq.ctx.Fields
	grbuild.label = answertruth.Label
...
func (atq *AnswerTruthQuery) Select(fields ...string) *AnswerTruthSelect {
	...
	sbuild := &AnswerTruthSelect{AnswerTruthQuery: atq}
	sbuild.label = answertruth.Label
	sbuild.flds, sbuild.scan = &atq.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a AnswerTruthSelect configured with the given aggregations.
func (atq *AnswerTruthQuery) Aggregate(fns ...AggregateFunc) *AnswerTruthSelect {
	return atq.Select().Aggregate(fns...)
}

func (atq *AnswerTruthQuery) prepareQuery(ctx context.Context) error {
...
func (atq *AnswerTruthQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(atq.driver.Dialect())
	t1 := builder.Table(answertruth.Table)
	columns := atq.ctx.Fields
	if len(columns) == 0 {
		columns = answertruth.Columns
	}
...
// AnswerTruthGroupBy is the group-by builder for AnswerTruth entities.
type AnswerTruthGroupBy struct {
	selector
	build *AnswerTruthQuery
}

// Aggregate adds the given aggregation functions to the group-by query.
func (atgb *AnswerTruthGroupBy) Aggregate(fns ...AggregateFunc) *AnswerTruthGroupBy {
	atgb.fns = append(atgb.fns, fns...)
	return atgb
}

// Scan applies the selector query and scans the result into the given value.
func (atgb *AnswerTruthGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, atgb.build.ctx, ent.OpQueryGroupBy)
	if err := atgb.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AnswerTruthQuery, *AnswerTruthGroupBy](ctx, atgb.build, atgb, atgb.build.inters, v)
}

func (atgb *AnswerTruthGroupBy) sqlScan(ctx context.Context, root *AnswerTruthQuery, v any) error {
...
// AnswerTruthSelect is the builder for selecting fields of AnswerTruth entities.
type AnswerTruthSelect struct {
	*AnswerTruthQuery
	selector
}

// Aggregate adds the given aggregation functions to the selector query.
func (ats *AnswerTruthSelect) Aggregate(fns ...AggregateFunc) *AnswerTruthSelect {
	ats.fns = append(ats.fns, fns...)
	return ats
}

// Scan applies the selector query and scans the result into the given value.
func (ats *AnswerTruthSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ats.ctx, ent.OpQuerySelect)
	if err := ats.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AnswerTruthQuery, *AnswerTruthSelect](ctx, ats.AnswerTruthQuery, ats, ats.inters, v)
}

func (ats *AnswerTruthSelect) sqlScan(ctx context.Context, root *AnswerTruthQuery, v any) error {
